  ...
  return (
    <div className="max-w-2xl mx-auto sm:mt-8 p-4 bg-slate-200 rounded">
      ...
      <div className="flex items-center mb-4">
         <input value={newTodoText} onChange= {(e) => setNewTodoText(e.target.value)} type="text" name="addTodoInput" id="addTodoInput" placeholder="할일 추가"
      ...
      <div className="flex items-center justify-between">
         ...
         <div className="flex items-center mb-4">
          ...
          name="searchTodoInput" id="searchTodoInput" placeholder="할일 검색" className="flex-grow p-2 border-b-2
